  ...
  module Bytecode
    class Compiler
      ...
      def compile_function(stmt, function_type)
        ...
        function[:name] = Rblox::Bytecode.memory_manager_copy_string(@vm[:memory_manager], stmt.name.lexeme, stmt.name.lexeme.bytesize)
      ...
      def make_identifier_constant(token, value)
        obj_string = Rblox::Bytecode.memory_manager_copy_string(@vm[:memory_manager], value, value.bytesize)
